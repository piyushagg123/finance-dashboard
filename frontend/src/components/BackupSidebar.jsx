...
const Sidebar = () => {
    ...
    return (
        <div>
            <div className={sidebarToggle ? "sidebar_div" : "sidebar_div toggle_sidebar"}>
                ...
                <div className="sidebar_data">
                    ...
                    <div className="side_profile">
                        <div className="side_profile_box">
                            ...
                            <button className="side_profile_box_button" tabIndex="0" type="button">
                                <div className="btn_left">
                                    <div className="side_profile_box_item">
                                        <div className="side_profile_box_item_text">M
                                        </div>
                                    </div>
                    ...
                    <div className="sidebar_drawer_body">
                        <ul className="sidebar_drawer_ul">
                            <NavLink className='sidebar_drawer_ul_link' to="/dashboard" onClick={mobileHandleToggle}>
                                <div className="sidebar_drawer_ul_btn" tabIndex="0" role="button">
                                    <div className="sidebar_drawer_ul_icon" aria-label="">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g opacity="0.75"><path opacity="0.12" d="M9.5 11C11.7091 11 13.5 9.20914 13.5 7C13.5 4.79086 11.7091 3 9.5 3C7.29086 3 5.5 4.79086 5.5 7C5.5 9.20914 7.29086 11 9.5 11Z" fill="white"></path><path d="M22 21V19C22 17.1362 20.7252 15.5701 19 15.126M15.5 3.29076C16.9659 3.88415 18 5.32131 18 7C18 8.67869 16.9659 10.1159 15.5 10.7092M17 21C17 19.1362 17 18.2044 16.6955 17.4693C16.2895 16.4892 15.5108 15.7105 14.5307 15.3045C13.7956 15 12.8638 15 11 15H8C6.13623 15 5.20435 15 4.46927 15.3045C3.48915 15.7105 2.71046 16.4892 2.30448 17.4693C2 18.2044 2 19.1362 2 21M13.5 7C13.5 9.20914 11.7091 11 9.5 11C7.29086 11 5.5 9.20914 5.5 7C5.5 4.79086 7.29086 3 9.5 3C11.7091 3 13.5 4.79086 13.5 7Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path></g></svg>
                                    </div>
                            ...
                            <NavLink className='sidebar_drawer_ul_link' to="/add" onClick={mobileHandleToggle}>
                                <div className="sidebar_drawer_ul_btn" tabIndex="0" role="button">
                                    <div className="sidebar_drawer_ul_icon" aria-label="">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g opacity="0.75"><path opacity="0.12" d="M9.5 11C11.7091 11 13.5 9.20914 13.5 7C13.5 4.79086 11.7091 3 9.5 3C7.29086 3 5.5 4.79086 5.5 7C5.5 9.20914 7.29086 11 9.5 11Z" fill="white"></path><path d="M22 21V19C22 17.1362 20.7252 15.5701 19 15.126M15.5 3.29076C16.9659 3.88415 18 5.32131 18 7C18 8.67869 16.9659 10.1159 15.5 10.7092M17 21C17 19.1362 17 18.2044 16.6955 17.4693C16.2895 16.4892 15.5108 15.7105 14.5307 15.3045C13.7956 15 12.8638 15 11 15H8C6.13623 15 5.20435 15 4.46927 15.3045C3.48915 15.7105 2.71046 16.4892 2.30448 17.4693C2 18.2044 2 19.1362 2 21M13.5 7C13.5 9.20914 11.7091 11 9.5 11C7.29086 11 5.5 9.20914 5.5 7C5.5 4.79086 7.29086 3 9.5 3C11.7091 3 13.5 4.79086 13.5 7Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path></g></svg>
                                    </div>
                            ...
                            <NavLink className='sidebar_drawer_ul_link' to="/reports" onClick={mobileHandleToggle}>
                                <div className="sidebar_drawer_ul_btn" tabIndex="0" role="button">
                                    <div className="sidebar_drawer_ul_icon" aria-label="">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g clipPath="url(#clip0_8931_11323)"><path d="M8 5H6C5.46957 5 4.96086 5.21071 4.58579 5.58579C4.21071 5.96086 4 6.46957 4 7V19C4 19.5304 4.21071 20.0391 4.58579 20.4142C4.96086 20.7893 5.46957 21 6 21H11.697" stroke="#B4B4CA" strokeLinecap="round" strokeLinejoin="round"></path><path d="M18 14V18H22" stroke="#B4B4CA" strokeLinecap="round" strokeLinejoin="round"></path><path d="M18 11V7C18 6.46957 17.7893 5.96086 17.4142 5.58579C17.0391 5.21071 16.5304 5 16 5H14" stroke="#B4B4CA" strokeLinecap="round" strokeLinejoin="round"></path><path d="M12 3H10C8.89543 3 8 3.89543 8 5C8 6.10457 8.89543 7 10 7H12C13.1046 7 14 6.10457 14 5C14 3.89543 13.1046 3 12 3Z" stroke="#B4B4CA" strokeLinecap="round" strokeLinejoin="round"></path><path d="M18 22C20.2091 22 22 20.2091 22 18C22 15.7909 20.2091 14 18 14C15.7909 14 14 15.7909 14 18C14 20.2091 15.7909 22 18 22Z" stroke="#B4B4CA" strokeLinecap="round" strokeLinejoin="round"></path><path d="M8 11H12" stroke="#B4B4CA" strokeLinecap="round" strokeLinejoin="round"></path><path d="M8 15H11" stroke="#B4B4CA" strokeLinecap="round" strokeLinejoin="round"></path></g><defs><clipPath id="clip0_8931_11323"><rect width="24" height="24" fill="white"></rect></clipPath></defs></svg>
                                    </div>
                            ...
                            <div className='sidebar_drawer_ul_link' onClick={() => handleDropdownClick('daybook')}>
                                <div className="sidebar_drawer_ul_btn" tabIndex="0" role="button">
                                    <div className="sidebar_drawer_ul_icon" aria-label="">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g clipPath="url(#clip0_8931_11323)"><path d="M8 5H6C5.46957 5 4.96086 5.21071 4.58579 5.58579C4.21071 5.96086 4 6.46957 4 7V19C4 19.5304 4.21071 20.0391 4.58579 20.4142C4.96086 20.7893 5.46957 21 6 21H11.697" stroke="#B4B4CA" strokeLinecap="round" strokeLinejoin="round"></path><path d="M18 14V18H22" stroke="#B4B4CA" strokeLinecap="round" strokeLinejoin="round"></path><path d="M18 11V7C18 6.46957 17.7893 5.96086 17.4142 5.58579C17.0391 5.21071 16.5304 5 16 5H14" stroke="#B4B4CA" strokeLinecap="round" strokeLinejoin="round"></path><path d="M12 3H10C8.89543 3 8 3.89543 8 5C8 6.10457 8.89543 7 10 7H12C13.1046 7 14 6.10457 14 5C14 3.89543 13.1046 3 12 3Z" stroke="#B4B4CA" strokeLinecap="round" strokeLinejoin="round"></path><path d="M18 22C20.2091 22 22 20.2091 22 18C22 15.7909 20.2091 14 18 14C15.7909 14 14 15.7909 14 18C14 20.2091 15.7909 22 18 22Z" stroke="#B4B4CA" strokeLinecap="round" strokeLinejoin="round"></path><path d="M8 11H12" stroke="#B4B4CA" strokeLinecap="round" strokeLinejoin="round"></path><path d="M8 15H11" stroke="#B4B4CA" strokeLinecap="round" strokeLinejoin="round"></path></g><defs><clipPath id="clip0_8931_11323"><rect width="24" height="24" fill="white"></rect></clipPath></defs></svg>
                                    </div>
                                ...
                                {dropdown === 'daybook' && (
                                    <>
                                        <NavLink className='sidebar_drawer_ul_link' to="/daybook/payable" onClick={mobileHandleToggle}>
                                            <div className="sidebar_drawer_ul_btn" tabIndex="0" role="button">
                                                <div className="sidebar_drawer_ul_icon" aria-label="">
                                                    <span>{" "}</span>
                                                </div>
                                                <div className="sidebar_drawer_ul_text" style={{ paddingLeft: "25px" }}>
                                                    <h5>Payable</h5>
                                                </div>
                                                <span className="sidebar_overflow_layer"></span>
                                            </div>
                                        ...
                                        <NavLink className='sidebar_drawer_ul_link' to="/daybook/receivable" onClick={mobileHandleToggle}>
                                            <div className="sidebar_drawer_ul_btn" tabIndex="0" role="button">
                                                <div className="sidebar_drawer_ul_icon" aria-label="">
                                                    {" "}
                                                </div>
                            ...
                            <NavLink className='sidebar_drawer_ul_link' to="/expenses-tracker" onClick={mobileHandleToggle}>
                                <div className="sidebar_drawer_ul_btn" tabIndex="0" role="button">
                                    <div className="sidebar_drawer_ul_icon" aria-label="">
                                        <svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 10V2C4 1.44772 4.44772 1 5 1H14C14.5523 1 15 1.44772 15 2V16H10.6957" stroke="white"></path><path d="M14 16H16C17.1046 16 18 15.1046 18 14V11H15.2" stroke="white"></path><path d="M6.5 5H13" stroke="white" strokeLinecap="round"></path><path d="M6.5 8H13" stroke="white" strokeLinecap="round"></path><path fillRule="evenodd" clipRule="evenodd" d="M1 11C0.447715 11 0 11.4477 0 12V17C0 17.5523 0.447715 18 1 18H10C10.5523 18 11 17.5523 11 17V12C11 11.4477 10.5523 11 10 11H1ZM5.5 16C6.32843 16 7 15.3284 7 14.5C7 13.6716 6.32843 13 5.5 13C4.67157 13 4 13.6716 4 14.5C4 15.3284 4.67157 16 5.5 16ZM0.75 12.5C0.75 12.0858 1.08579 11.75 1.5 11.75H9.5C9.91421 11.75 10.25 12.0858 10.25 12.5V16.5C10.25 16.9142 9.91421 17.25 9.5 17.25H1.5C1.08579 17.25 0.75 16.9142 0.75 16.5V12.5ZM1.5 12.25C1.36193 12.25 1.25 12.3619 1.25 12.5V16.5C1.25 16.6381 1.36193 16.75 1.5 16.75H9.5C9.63807 16.75 9.75 16.6381 9.75 16.5V12.5C9.75 12.3619 9.63807 12.25 9.5 12.25H1.5Z" fill="white"></path></svg>
                                    </div>
                            ...
                            <div className='sidebar_drawer_ul_link' onClick={() => handleDropdownClick('matchSettling')}>
                                <div className="sidebar_drawer_ul_btn" tabIndex="0" role="button">
                                    <div className="sidebar_drawer_ul_icon" aria-label="">
                                        <svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 10V2C4 1.44772 4.44772 1 5 1H14C14.5523 1 15 1.44772 15 2V16H10.6957" stroke="white"></path><path d="M14 16H16C17.1046 16 18 15.1046 18 14V11H15.2" stroke="white"></path><path d="M6.5 5H13" stroke="white" strokeLinecap="round"></path><path d="M6.5 8H13" stroke="white" strokeLinecap="round"></path><path fillRule="evenodd" clipRule="evenodd" d="M1 11C0.447715 11 0 11.4477 0 12V17C0 17.5523 0.447715 18 1 18H10C10.5523 18 11 17.5523 11 17V12C11 11.4477 10.5523 11 10 11H1ZM5.5 16C6.32843 16 7 15.3284 7 14.5C7 13.6716 6.32843 13 5.5 13C4.67157 13 4 13.6716 4 14.5C4 15.3284 4.67157 16 5.5 16ZM0.75 12.5C0.75 12.0858 1.08579 11.75 1.5 11.75H9.5C9.91421 11.75 10.25 12.0858 10.25 12.5V16.5C10.25 16.9142 9.91421 17.25 9.5 17.25H1.5C1.08579 17.25 0.75 16.9142 0.75 16.5V12.5ZM1.5 12.25C1.36193 12.25 1.25 12.3619 1.25 12.5V16.5C1.25 16.6381 1.36193 16.75 1.5 16.75H9.5C9.63807 16.75 9.75 16.6381 9.75 16.5V12.5C9.75 12.3619 9.63807 12.25 9.5 12.25H1.5Z" fill="white"></path></svg>
                                    </div>
                                    ...
                                    <div className="sidebar_drawer_ul_text">
                                        ...
                                        {
                                            dropdown === "matchSettling" ? <FaAngleUp /> : <FaAngleDown />
                                        }
                                    </div>
                                    <span className="sidebar_overflow_layer"></span>
                                </div>
                                ...
                                {dropdown === 'matchSettling' && (
                                    <>
                                        <NavLink className='sidebar_drawer_ul_link' to="/match-settling/result" onClick={mobileHandleToggle}>
                                            <div className="sidebar_drawer_ul_btn" tabIndex="0" role="button">
                                                <div className="sidebar_drawer_ul_icon" aria-label="">
                                                    {" "}
                                                </div>
                                        ...
                                        <NavLink className='sidebar_drawer_ul_link' to="/match-settling/report" onClick={mobileHandleToggle}>
                                            <div className="sidebar_drawer_ul_btn" tabIndex="0" role="button">
                                                <div className="sidebar_drawer_ul_icon" aria-label="">
                                                    {" "}
                                                </div>
                            ...
                            <div className='sidebar_drawer_ul_link' to="/settling" onClick={() => handleDropdownClick('settling')}>
                                <div className="sidebar_drawer_ul_btn" tabIndex="0" role="button">
                                    <div className="sidebar_drawer_ul_icon" aria-label="">
                                        <svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 10V2C4 1.44772 4.44772 1 5 1H14C14.5523 1 15 1.44772 15 2V16H10.6957" stroke="white"></path><path d="M14 16H16C17.1046 16 18 15.1046 18 14V11H15.2" stroke="white"></path><path d="M6.5 5H13" stroke="white" strokeLinecap="round"></path><path d="M6.5 8H13" stroke="white" strokeLinecap="round"></path><path fillRule="evenodd" clipRule="evenodd" d="M1 11C0.447715 11 0 11.4477 0 12V17C0 17.5523 0.447715 18 1 18H10C10.5523 18 11 17.5523 11 17V12C11 11.4477 10.5523 11 10 11H1ZM5.5 16C6.32843 16 7 15.3284 7 14.5C7 13.6716 6.32843 13 5.5 13C4.67157 13 4 13.6716 4 14.5C4 15.3284 4.67157 16 5.5 16ZM0.75 12.5C0.75 12.0858 1.08579 11.75 1.5 11.75H9.5C9.91421 11.75 10.25 12.0858 10.25 12.5V16.5C10.25 16.9142 9.91421 17.25 9.5 17.25H1.5C1.08579 17.25 0.75 16.9142 0.75 16.5V12.5ZM1.5 12.25C1.36193 12.25 1.25 12.3619 1.25 12.5V16.5C1.25 16.6381 1.36193 16.75 1.5 16.75H9.5C9.63807 16.75 9.75 16.6381 9.75 16.5V12.5C9.75 12.3619 9.63807 12.25 9.5 12.25H1.5Z" fill="white"></path></svg>
                                    </div>
                                ...
                                {dropdown === 'settling' && (
                                    <>
                                        <NavLink className='sidebar_drawer_ul_link' to="/settling/transaction" onClick={mobileHandleToggle}>
                                            <div className="sidebar_drawer_ul_btn" tabIndex="0" role="button">
                                                <div className="sidebar_drawer_ul_icon" aria-label="">
                                                    {" "}
                                                </div>
                                        ...
                                        <NavLink className='sidebar_drawer_ul_link' to="/settling/report" onClick={mobileHandleToggle}>
                                            <div className="sidebar_drawer_ul_btn" tabIndex="0" role="button">
                                                <div className="sidebar_drawer_ul_icon" aria-label="">
                                                    {" "}
                                                </div>
                            ...
                            <NavLink className='sidebar_drawer_ul_link' to="/payroll" onClick={mobileHandleToggle}>
                                <div className="sidebar_drawer_ul_btn" tabIndex="0" role="button">
                                    <div className="sidebar_drawer_ul_icon" aria-label="">
                                        <svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 10V2C4 1.44772 4.44772 1 5 1H14C14.5523 1 15 1.44772 15 2V16H10.6957" stroke="white"></path><path d="M14 16H16C17.1046 16 18 15.1046 18 14V11H15.2" stroke="white"></path><path d="M6.5 5H13" stroke="white" strokeLinecap="round"></path><path d="M6.5 8H13" stroke="white" strokeLinecap="round"></path><path fillRule="evenodd" clipRule="evenodd" d="M1 11C0.447715 11 0 11.4477 0 12V17C0 17.5523 0.447715 18 1 18H10C10.5523 18 11 17.5523 11 17V12C11 11.4477 10.5523 11 10 11H1ZM5.5 16C6.32843 16 7 15.3284 7 14.5C7 13.6716 6.32843 13 5.5 13C4.67157 13 4 13.6716 4 14.5C4 15.3284 4.67157 16 5.5 16ZM0.75 12.5C0.75 12.0858 1.08579 11.75 1.5 11.75H9.5C9.91421 11.75 10.25 12.0858 10.25 12.5V16.5C10.25 16.9142 9.91421 17.25 9.5 17.25H1.5C1.08579 17.25 0.75 16.9142 0.75 16.5V12.5ZM1.5 12.25C1.36193 12.25 1.25 12.3619 1.25 12.5V16.5C1.25 16.6381 1.36193 16.75 1.5 16.75H9.5C9.63807 16.75 9.75 16.6381 9.75 16.5V12.5C9.75 12.3619 9.63807 12.25 9.5 12.25H1.5Z" fill="white"></path></svg>
                                    </div>
                            ...
                            <NavLink className='sidebar_drawer_ul_link' to="/settings" onClick={mobileHandleToggle}>
                                <div className="sidebar_drawer_ul_btn" tabIndex="0" role="button">
                                    <div className="sidebar_drawer_ul_icon" aria-label="">
                                        <svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 10V2C4 1.44772 4.44772 1 5 1H14C14.5523 1 15 1.44772 15 2V16H10.6957" stroke="white"></path><path d="M14 16H16C17.1046 16 18 15.1046 18 14V11H15.2" stroke="white"></path><path d="M6.5 5H13" stroke="white" strokeLinecap="round"></path><path d="M6.5 8H13" stroke="white" strokeLinecap="round"></path><path fillRule="evenodd" clipRule="evenodd" d="M1 11C0.447715 11 0 11.4477 0 12V17C0 17.5523 0.447715 18 1 18H10C10.5523 18 11 17.5523 11 17V12C11 11.4477 10.5523 11 10 11H1ZM5.5 16C6.32843 16 7 15.3284 7 14.5C7 13.6716 6.32843 13 5.5 13C4.67157 13 4 13.6716 4 14.5C4 15.3284 4.67157 16 5.5 16ZM0.75 12.5C0.75 12.0858 1.08579 11.75 1.5 11.75H9.5C9.91421 11.75 10.25 12.0858 10.25 12.5V16.5C10.25 16.9142 9.91421 17.25 9.5 17.25H1.5C1.08579 17.25 0.75 16.9142 0.75 16.5V12.5ZM1.5 12.25C1.36193 12.25 1.25 12.3619 1.25 12.5V16.5C1.25 16.6381 1.36193 16.75 1.5 16.75H9.5C9.63807 16.75 9.75 16.6381 9.75 16.5V12.5C9.75 12.3619 9.63807 12.25 9.5 12.25H1.5Z" fill="white"></path></svg>
                                    </div>
